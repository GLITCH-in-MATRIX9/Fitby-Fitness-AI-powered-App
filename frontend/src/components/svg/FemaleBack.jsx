// src/components/svgs/FemaleFrontSVG.jsx
import React from "react";

const FemaleBack = ({ onMuscleClick }) => {
  return (
    <svg
      viewBox="0 0 660.46 1206.46"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-full max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px] xl:max-w-[700px] h-auto mx-auto cursor-pointer"
      onClick={(e) => {
        const muscleId = e.target.closest("g")?.id || e.target.id;
    ...
    >
      ...
      <g
        id="rearshoulders"
        className="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
        onClick={() => onMuscleClick('rearshoulders')}
      ...
      <g
        id="trapsmiddle"
        className="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
        onClick={() => onMuscleClick('trapsmiddle')}
      >
        <path
      ...
      <g id="upper-spine" className="hidden"></g>
      <g id="lower-spine" className="hidden"></g>
      <g id="scapula" className="hidden"></g>
      <g id="ankles" className="hidden"></g>
      <g id="knees" className="hidden"></g>
      <g id="wrist" className="hidden"></g>
    </svg>
  );
};
